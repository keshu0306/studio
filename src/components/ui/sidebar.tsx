...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      data-sidebar="header"
      className={cn("flex items-center min-h-[3.5rem] gap-2 p-2", className)} 
      {...props}
    />
  )
})
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-none ring-sidebar-ring transition-[width,height,padding] focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-gradient-to-r data-[state=open]:hover:from-neon-green-start data-[state=open]:hover:to-neon-green-end data-[state=open]:hover:text-neon-hover-text group-data-[collapsible=icon]:!size-8 group-data-[collapsible=icon]:!p-2 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "hover:bg-gradient-to-r hover:from-neon-green-start hover:to-neon-green-end hover:text-neon-hover-text",
        outline:
          "bg-background shadow-[0_0_0_1px_hsl(var(--sidebar-border))] hover:bg-gradient-to-r hover:from-neon-green-start hover:to-neon-green-end hover:text-neon-hover-text hover:shadow-[0_0_0_1px_hsl(var(--neon-green-start))]",
      },
      size: {
        default: "h-8 text-sm",
        sm: "h-7 text-xs",
...
interface SidebarMenuButtonProps
  extends Omit<React.ComponentProps<typeof Button>, "href">, 
